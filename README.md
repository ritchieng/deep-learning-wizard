# Deep Learning Wizard Resources
...
We always provide the latest PyTorch version (currently 0.4 or 1.0 pre-release) so rest assured that you will be learning up-to-date code! 
